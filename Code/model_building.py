...
x_train =  pd.read_csv("D:/Thyroid_Disease_Detection-main/Code/x_train.csv")
y_train =  pd.read_csv("D:/Thyroid_Disease_Detection-main/Code/y_train.csv")
logging.info("Read the training data successfully.")

logging.info("Reading testing dataset........")
x_test =  pd.read_csv("D:/Thyroid_Disease_Detection-main/Code/x_test.csv")
y_test =  pd.read_csv("D:/Thyroid_Disease_Detection-main/Code/y_test.csv")
logging.info("Read the testing data successfully.")

logging.info("Reading validation dataset........")
x_valid =  pd.read_csv("D:/Thyroid_Disease_Detection-main/Code/x_valid.csv")
y_valid =  pd.read_csv("D:/Thyroid_Disease_Detection-main/Code/y_valid.csv")
...
def hyparameter_tuning_rf(model, x, y, final_features):
    ...
    tuned_model.fit(x[final_features], y["outcome"])
